...
TEST(byte_hh, count_leading_0) {
    EXPECT_EQ(28, libaan::count_leading_0(uint32_t(0xf)));
    EXPECT_EQ(16, libaan::count_leading_0(uint32_t(0xffff)));
    EXPECT_EQ(0, libaan::count_leading_0(uint32_t(0xffffffff)));
    EXPECT_EQ(4, libaan::count_leading_0(uint32_t(0xfffffff)));
    EXPECT_EQ(0, libaan::count_leading_0(uint32_t(0xf0000000)));
    EXPECT_EQ(0, libaan::count_leading_0(uint32_t(0xffff0000)));
    EXPECT_EQ(0, libaan::count_leading_0(uint32_t(0xfffffff0)));
    EXPECT_EQ(0, libaan::count_leading_0(uint32_t(0xffffffff)));
